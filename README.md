...
# Original README from SLAMBench #
SLAMBooster is an application-aware online controller for dense SLAM algorithms implemented in the SLAMBench framework.
More changes are needed: LISENCE, README, DOCUMENT
